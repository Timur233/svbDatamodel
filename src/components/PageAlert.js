...
class PageAlert extends SvbElement {
        ...
        if (icon) {
            ...
            this.icon.innerHTML = `
                <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M79.1282 79.167H79.1678M79.1282 79.167C76.5336 81.7399 71.8316 81.099 68.5341 81.099C64.4866 
                    81.099 62.5374 81.8907 59.6486 84.7795C57.1891 87.2395 53.8916 91.667 50.0011 91.667C46.1107 91.667 
                    42.8132 87.2395 40.3535 84.7795C37.4648 81.8907 35.5157 81.099 31.4681 81.099C28.1706 81.099 23.4686 
                    81.7399 20.874 79.167C18.2587 76.5736 18.9023 71.852 18.9023 68.5332C18.9023 64.3395 17.9851 62.4111 
                    14.9986 59.4245C10.5559 54.982 8.33456 52.7603 8.33447 50.0003C8.33451 47.2399 10.5558 45.0186 14.9984 
                    40.576C17.6645 37.91 18.9023 35.2681 18.9023 31.4672C18.9023 28.1697 18.2615 23.4675 20.8345 20.873C23.4279 
                    18.2577 28.1495 18.9014 31.4681 18.9014C35.2689 18.9014 37.9108 17.6636 40.5768 14.9977C45.0195 10.555 
                    47.2407 8.33362 50.0011 8.33362C52.7616 8.33362 54.9828 10.555 59.4253 14.9977C62.0907 17.6631 64.7324 
                    18.9014 68.5341 18.9014C71.8316 18.9014 76.5341 18.2606 79.1286 20.8336C81.7436 23.4271 81.0999 28.1486 
                    81.0999 31.4672C81.0999 35.661 82.0174 37.5893 85.0036 40.576C89.4466 45.0186 91.6678 47.2399 91.6678 
                    50.0003C91.6678 52.7603 89.4466 54.982 85.0036 59.4245C82.017 62.4111 81.0999 64.3395 81.0999 68.5332C81.0999 
                    71.852 81.7436 76.5736 79.1282 79.167Z" stroke="url(#paint1_linear_2246_112511)" stroke-width="9.375"/>
                    ...
                    <defs>
                    <linearGradient id="paint0_linear_2246_112511" x1="75.0335" y1="83.8935" x2="16.1073" y2="24.9684" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#0078BF"/>
                        <stop offset="1" stop-color="#00A0E3"/>
                    </linearGradient>
                    <linearGradient id="paint1_linear_2246_112511" x1="75.0335" y1="83.8935" x2="16.1073" y2="24.9684" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#0078BF"/>
                        <stop offset="1" stop-color="#00A0E3"/>
                    </linearGradient>
                    </defs>
        ...
        if (icon) {
            ...
            this.icon.innerHTML = `
                <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    50C82.3392 50 91.6667 59.3275 91.6667 70.8333Z" stroke="white" stroke-width="6" stroke-linecap="round"/>
    ...
    renderButtons() {
        this.state.buttons.forEach(b => {
            const button = SvbElement.create('button', null, 'btn btn--gray', b.title);
